			...
			<div id="carousel-related-product">
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
						...
						<div class="card-body">
							<a href="shop-single.do" class="h3 text-decoration-none">Red
								Clothing</a>
							<ul
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
						...
						<div class="card-body">
							<a href="shop-single.do" class="h3 text-decoration-none">White
								Shirt</a>
							<ul
								class="w-100 list-unstyled d-flex justify-content-between mb-0">
								<li>M/L/X/XL</li>
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
						...
						<div class="card-body">
							<a href="shop-single.do" class="h3 text-decoration-none">Black
								Fashion</a>
							<ul
								class="w-100 list-unstyled d-flex justify-content-between mb-0">
								<li>M/L/X/XL</li>
